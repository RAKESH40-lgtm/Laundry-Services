...
const ProductItem = (props) => {
  ...
  return (
    <>
      ...
      <div id={styles.productRow}>
        <div className={styles.productType}>
          <img className={styles.prodImg} src={`${props.info.image}`} alt="" />
        ...
        <div className={styles.prodQuant}>
          <div className={styles.quantnum}>
            <input
              className={styles.quantVal}
              type="text"
              name="quantity"
        ...
        <div className={styles.washTypes}>
          <img
            alt=""
            className={styles.washImg}
            index="0"
            src={`${
        ...
        {/* //to calculate prize */}
          ...
          <div id={styles.price}>
            {itemPriceDetail.itemPrice ? (
              <div id={styles.prodPrice}>
                <div className={styles.itemForEach}>
                  {props.orderDetails[props.info.name].quantity +
                    "X" +
                    itemPriceDetail.PerItemPrice}{" "}
                  =
                </div>
                <div className={styles.priceVal}>{itemPriceDetail.itemPrice}</div>
              </div>
            ) : (
              "__"
            )}
